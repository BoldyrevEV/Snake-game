 ...
 * @property {int} maxX максимальная координата по x.
 * @property {int} maxY максимальная координата по y.
 */
const snake = {
    body: null,
    direction: null,
    ...
    init(startBody, direction) {
        ...
        // задаем максимальные координаты
        this.maxX = settings.rowsCount;
        this.maxY = settings.colsCount;
    },
...
const score = {
    ...
    init() {
        ...
        // меняем цвет текста на красный для лучшего отображения.
        document.getElementById('game-score').style.color = 'red';
        // выравниваем текст по центру.
        document.getElementById('game-score').style.textAlign = 'center';
 ...
 * @property {score} settings Объект счетчика. Подсчитывает очки пользователя.
 */
const game = {
    config,
    map,
